  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-8 " >
      <div className="container w-full px-4 flex flex-wrap items-center justify-evenly">
        <nav className="flex flex-wrap justify-center gap-12 w-full ">
          <a
            href="/#home"
      ...
      <div className="container flex flex-col  gap-4 mx-auto px-4 text-center mt-8">
        <div className="social-icons flex mb-4 md:mb-0 justify-center gap-12 items-center">
          <a
        ...
        <div className="text-md tracking-widest w-full">
